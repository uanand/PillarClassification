...
def plotHistoryModel1():
    ...
    rect1 = patches.Rectangle((1,-0.02),86,1.02,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((86,-0.02),91,1.02,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((177,-0.02),100,1.02,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ...
    ax = fig.add_axes([0,0,1,1])
    rect2 = patches.Rectangle((insetLimit[0],0),177-insetLimit[0],0.04,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((177,0),insetLimit[1]-177,0.04,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ...
    fig = plt.figure(figsize=(3,2))
    ax = fig.add_axes([0,0,1,1])
    rect1 = patches.Rectangle((1,50),86,52,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((86,50),91,52,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((177,50),100,52,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ...
    fig = plt.figure(figsize=(1,0.66))
    ax = fig.add_axes([0,0,1,1])
    rect2 = patches.Rectangle((insetLimit[0],98.4),177-insetLimit[0],1.2,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((177,98.4),insetLimit[1]-177,1.2,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect2)
    ax.add_patch(rect3)
...
def plotHistoryModel2():
    ...
    fig = plt.figure(figsize=(3,2))
    ax = fig.add_axes([0,0,1,1])
    rect1 = patches.Rectangle((1,-0.02),25,0.52,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((25,-0.02),7,0.52,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((32,-0.02),20,0.52,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs,loss,label='train',color='b')
    ...
    fig = plt.figure(figsize=(1,0.66))
    ax = fig.add_axes([0,0,1,1])
    rect2 = patches.Rectangle((insetLimit[0],0.004),32-insetLimit[0],0.022,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((32,0.004),insetLimit[1]-32,0.022,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],loss[insetLimit[0]-1:insetLimit[1]],color='b')
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],val_loss[insetLimit[0]-1:insetLimit[1]],color='g')
    ...
    fig = plt.figure(figsize=(3,2))
    ax = fig.add_axes([0,0,1,1])
    rect1 = patches.Rectangle((1,70),25,31,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((25,70),7,31,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((32,70),20,31,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs,accuracy,label='train',color='b')
    ...
    fig = plt.figure(figsize=(1,0.66))
    ax = fig.add_axes([0,0,1,1])
    rect2 = patches.Rectangle((insetLimit[0],99.25),32-insetLimit[0],0.6,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((32,99.25),insetLimit[1]-32,0.6,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],accuracy[insetLimit[0]-1:insetLimit[1]],color='b')
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],val_accuracy[insetLimit[0]-1:insetLimit[1]],color='g')
...
def plotHistoryModelVGG():
    ...
    fig = plt.figure(figsize=(3,2))
    ax = fig.add_axes([0,0,1,1])
    rect1 = patches.Rectangle((1,-0.02),3,1.02,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((4,-0.02),50,1.02,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((54,-0.02),100,1.02,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs,loss,label='train',color='b')
    ...
    fig = plt.figure(figsize=(1,0.66))
    ax = fig.add_axes([0,0,1,1])
    rect3 = patches.Rectangle((120,0.002),insetLimit[1]-120,0.006,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect3)
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],loss[insetLimit[0]-1:insetLimit[1]],color='b')
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],val_loss[insetLimit[0]-1:insetLimit[1]],color='g')
    ax.set_xlabel('Epochs')
    ...
    fig = plt.figure(figsize=(3,2))
    ax = fig.add_axes([0,0,1,1])
    rect1 = patches.Rectangle((1,80),3,21,linewidth=None,edgecolor=None,facecolor='#E7E8E9')
    rect2 = patches.Rectangle((4,80),50,21,linewidth=None,edgecolor=None,facecolor='#D1D2D4')
    rect3 = patches.Rectangle((54,80),100,21,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect1)
    ax.add_patch(rect2)
    ax.add_patch(rect3)
    ax.plot(epochs,accuracy,label='train',color='b')
    ...
    fig = plt.figure(figsize=(1,0.66))
    ax = fig.add_axes([0,0,1,1])
    rect3 = patches.Rectangle((120,99.6),insetLimit[1]-120,0.4,linewidth=None,edgecolor=None,facecolor='#BDBEC0')
    ax.add_patch(rect3)
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],accuracy[insetLimit[0]-1:insetLimit[1]],color='b')
    ax.plot(epochs[insetLimit[0]-1:insetLimit[1]],val_accuracy[insetLimit[0]-1:insetLimit[1]],color='g')
    ax.set_xlabel('Epochs')
